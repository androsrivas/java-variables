public class Universe {
    public static void main(String[] args) {
        ...
        //Java no permite una variable de tipo int, mayor que 2 147 483 647 por lo que la población mundial
        //no cabe en un int.
        //Intenta hacer una variable de tipo int con el valor de la población actual y mira el error.

        //Escribe aquí tu código
        //int totalPopulation = 8118302456;

        //Para poder almacenar la población mundial tenemos que definir el tipo de dato long que almacena
        //un valor de hasta 9 223 372 036 854 775 807
        ...
        //Eso es debido a que cuando definimos una variable de tipo long debemos poner una L
        //al final del último número.
        //Inténtalo de nuevo
        //Escribe aquí tu código
        //population = 8118302456L;

        //Un número largo sin tener un separador de millares, cuesta mucho de leer,
        //es más fácil entender este valor 8 118 302 456,
        //java nos permite tener este espacio con el underscore, cada tres dígitos.
        ...
        //El problema es que está añadiendo el valor de milkyWay al String anterior,
        //lo que convierte ese valor en String y cuando llega a andromeda también lo convierte a String
        //y no puede hacer la operación matemática. Para dar prioridades de operaciones, usamos los paréntesis.
